...
pub struct Collateral{
    pub depositor:Pubkey,  //depositor wallet balance
    pub sol_account:Pubkey,  // depositor pda collateral account (deposit SOL to this account)
    pub token_account:Pubkey, // depositor associated token account (mint stablecoins to this account)
    ...
    pub bump_sol_account:u8, // store bump seed for sol_account PDA
